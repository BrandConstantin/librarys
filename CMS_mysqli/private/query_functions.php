...
function insert_subject($subject) {
    ...
    $sql .= ")";
    $result = mysqli_query($db, $sql);
    //form insert statments, the result is true/false
    if ($result) {
        return true;
    } else {
...
function validate_page($page) {
    ...
    if (!has_unique_page_menu_name($page['page_name'], $current_id)) {
...
function update_admin($admin) {
    ...
    //change the password is optional
...
////////////////////////////////////////////////////////////////////////////////
//shift the position of subjects
