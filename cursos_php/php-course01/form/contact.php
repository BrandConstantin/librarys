...
if (isset($_POST['send'])) {
    ...
    $to = 'David Powers <david@example.com>, Paul Powers <paul@example.com>';
    ...
    $authorized = null;
    //se tiene que escribir el correo del dominio contratado
//    $authorized = '-fdavid@example.com';
    //estas lineas deben estar por encima del require //////////////////////
