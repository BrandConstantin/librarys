...
if (!function_exists('constantores_setup')) :
    ...
    function constantores_setup() {
        ...
        add_image_size('constantores-full-bleed', 1200, 300, true);
        add_image_size('constantores-index-img', 1000, 550, true);

        // This theme uses wp_nav_menu() in one location.
        register_nav_menus(array(
            'primary' => esc_html__('Header Menu', 'constantores'),
        ...
        /* Editor styles */
        add_editor_style(array('inc/editor-styles.css', constantores_fonts_url()));
    }
 ...
 */
function constantores_content_image_sizes_attr($sizes, $size) {
    $width = $size[0];
...
add_filter('wp_calculate_image_sizes', 'constantores_content_image_sizes_attr', 10, 2);
 ...
 */
function constantores_header_image_tag($html, $header, $attr) {
    if (isset($attr['sizes'])) {
...
add_filter('get_header_image_tag', 'constantores_header_image_tag', 10, 3);
 ...
 */
function constantores_post_thumbnail_sizes_attr($attr, $attachment, $size) {
...
add_filter('wp_get_attachment_image_attributes', 'constantores_post_thumbnail_sizes_attr', 10, 3);
...
function constantores_widgets_init() {
    register_sidebar(array(
        ...
        'id' => 'sidebar-1',
        'description' => esc_html__('Add sidebar widgets here.', 'constantores'),
    ...
    register_sidebar(array(
        'name' => esc_html__('Page Sidebar', 'constantores'),
        'id' => 'sidebar-2',
        'description' => esc_html__('Add page sidebar widgets here.', 'constantores'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
        'before_title' => '<h2 class="widget-title">',
        'after_title' => '</h2>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer Widgets', 'constantores'),
        'id' => 'footer-1',
        'description' => esc_html__('Add footer widgets here.', 'constantores'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
        'before_title' => '<h2 class="widget-title">',
        'after_title' => '</h2>',
