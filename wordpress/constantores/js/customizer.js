...
( function( $ ) {
	...
	wp.customize( 'interactive_color', function( value ) {
		value.bind( function( to ) {
			$( 'a:hover,a:focus,a:active,.page-content a:focus, .page-content a:hover,.entry-content a:focus,.entry-content a:hover,.entry-summary a:focus,.entry-summary a:hover,.comment-content a:focus,.comment-content a:hover,.cat-links a,.social-menu ul a.widget_constantores_recent_posts a:hover .title,.widget_constantores_recent_posts a:focus .title,.widget_constantores_recent_comments a:focus .original-title,.widget_constantores_recent_comments a:hover .original-title,.pagination .current' ).css( {
			...
			$( '.comment-navigation a:hover,.comment-navigation a:focus,.posts-navigation a:hover,.posts-navigation a:focus,.post-navigation a:hover,.post-navigation a:focus,.paging-navigation a:hover,.paging-navigation a:focus,.continue-reading a:focus,.continue-reading a:hover,.cat-links a:focus,.cat-links a:hover,.reply a:hover,.reply a:focus,.comment-form .form-submit input:hover,.comment-form .form-submit input:focus,.pagination a:focus,.pagination a:hover' ).css( {
				'background-color': to
			} );
		} );
	} );
